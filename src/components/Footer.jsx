...
export default function Footer() {
  return (
    <footer style={{ background: '#050505', borderTop: '1px solid #111', marginTop: '0' }}>
      ...
      {/* BLOQUE PRINCIPAL */}
      <div style={{ maxWidth: '1200px', margin: '0 auto', borderBottom: '1px solid #111' }}>
        <div className="footer-grid" style={{ padding: '72px 48px 56px' }}>
          ...
          <div>
            ...
            <p style={{ color: '#444', fontSize: '13px', lineHeight: '1.85', maxWidth: '260px' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
              {[
                ...
                <div key={dia} style={{
                  ...
                  borderBottom: '1px solid #0f0f0f', paddingBottom: '10px',
                }}>
                  <span style={{ fontFamily: "'Manrope', sans-serif", fontSize: '12px', color: '#555' }}>{dia}</span>
                  <span style={{ fontFamily: "'Oswald', sans-serif", fontSize: '12px', letterSpacing: '0.06em', color: open ? '#888' : '#2a2a2a' }}>{hora}</span>
                </div>
              ))}
            </div>
          </div>
          ...
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '10px', marginBottom: '36px' }}>
              {[
                ...
                const inner = (
                  <span style={{ display: 'flex', alignItems: 'flex-start', gap: '10px', fontSize: '12px', color: '#555', transition: 'color 0.2s' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
              {[
                ...
                <Link key={to} to={to} style={{
                  ...
                  color: '#3a3a3a', textDecoration: 'none', transition: 'color 0.2s',
                }}
                  onMouseOver={e => e.currentTarget.style.color = gold}
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
        <div className="footer-bottom">
          ...
          <div className="footer-divider" style={{ width: '24px', height: '1px', background: '#1a1a1a' }} />
          <span style={{
            fontFamily: "'Oswald', sans-serif",
